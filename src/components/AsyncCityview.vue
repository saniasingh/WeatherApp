<template>
  <div class="flex flex-col flex-1 items-center">
    ...
    <!-- Weather Overview -->
    <div class="flex flex-col items-center text-white pt-12 pb-6">
    ...
    <div class="max-w-screen-md w-full py-12">
      <div class="mx-8 text-white">
        <h2 class="mb-4 text-2xl">7 Day Forcast</h2>
        <div
        ...
        >
          ...
          <div class="flex gap-2 flex-1 justify-end">
            <p>⬆️ {{ Math.round(day.temp.max) }}&deg;</p>
            <p>⬇️ {{ Math.round(day.temp.min) }}&deg;</p>
          </div>
        </div>
      </div>
    </div>
